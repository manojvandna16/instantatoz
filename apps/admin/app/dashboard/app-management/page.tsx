  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Manage app versions, feature flags, and mobile app settings.</p>
      </div>
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-12 text-center">
        <div className="w-12 h-12 bg-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Smartphone className="w-6 h-6 text-blue-400" />
        </div>
        <p className="text-white font-semibold">App Management</p>
