...
export default function ContentPage() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold text-white">Website Content</h1>
        <p className="text-sm text-gray-400 mt-0.5">Manage banners, FAQs, and other website content blocks.</p>
      </div>
